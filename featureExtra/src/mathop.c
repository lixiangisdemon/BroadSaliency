...
/* ---------------------------------------------------------------- */
 ...
 T
	 _vl_distance_l2_f(vl_size dimension, T const * X, T const * Y)
{
 ...
 T
	 _vl_distance_l1_f(vl_size dimension, T const * X, T const * Y)
{
  T const * X_end = X + dimension ;
  T acc = 0.0 ;
  while (X < X_end) {
 ...
 T
	 _vl_distance_chi2_f(vl_size dimension, T const * X, T const * Y)
{
  T const * X_end = X + dimension ;
  T acc = 0.0 ;
  while (X < X_end) {
 ...
 T
	 _vl_distance_hellinger_f(vl_size dimension, T const * X, T const * Y)
{
  T const * X_end = X + dimension ;
  T acc = 0.0 ;
  while (X < X_end) {
 ...
 T
	 _vl_distance_js_f(vl_size dimension, T const * X, T const * Y)
{
  T const * X_end = X + dimension ;
  T acc = 0.0 ;
  while (X < X_end) {
 ...
 T
	 _vl_kernel_l2_f(vl_size dimension, T const * X, T const * Y)
{
  T const * X_end = X + dimension ;
  T acc = 0.0 ;
  while (X < X_end) {
 ...
 T
	 _vl_kernel_l1_f(vl_size dimension, T const * X, T const * Y)
{
  T const * X_end = X + dimension ;
  T acc = 0.0 ;
  while (X < X_end) {
 ...
 T
	 _vl_kernel_chi2_f(vl_size dimension, T const * X, T const * Y)
{
  T const * X_end = X + dimension ;
  T acc = 0.0 ;
  while (X < X_end) {
 ...
 T
	 _vl_kernel_hellinger_f(vl_size dimension, T const * X, T const * Y)
{
  T const * X_end = X + dimension ;
  T acc = 0.0 ;
  while (X < X_end) {
 ...
 T
	 _vl_kernel_js_f(vl_size dimension, T const * X, T const * Y)
{
  T const * X_end = X + dimension ;
  T acc = 0.0 ;
  while (X < X_end) {
 ...
 T
	 _vl_distance_mahalanobis_sq_f(vl_size dimension, T const * X, T const * MU, T const * S)
{
  T const * X_end = X + dimension ;
  T acc = 0.0 ;
  while (X < X_end) {
